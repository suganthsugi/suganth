  ...
  return (
    <div>
      <section className="max-w-[640px] pb-11 pt-4 sm:pt-8">
        ...
        <h1 className="m-0 mb-[18px] font-serif text-[clamp(32px,4.6vw,50px)] font-normal leading-[1.08] tracking-tight text-ink">
          Tell me what you&rsquo;re building.
        </h1>
        <p className="m-0 text-pretty text-base leading-relaxed text-ink2">
          {config?.availability
      ...
      <section className="grid gap-x-14 gap-y-10 pb-[88px] sm:grid-cols-[minmax(0,1fr)_260px]">
